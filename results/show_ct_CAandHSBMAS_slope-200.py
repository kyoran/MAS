...
max_y, min_y = 0, 30
min_y_delta, max_y_delta =10, 400
...
ax.text(xs[0], getUpNum(max_y)+max_y_delta, methods[0], horizontalalignment='center', verticalalignment='center', fontdict={'size':18, 'weight':700})
ax.text(xs[1], getUpNum(max_y)+max_y_delta, methods[1], horizontalalignment='center', verticalalignment='center', fontdict={'size':18, 'weight':700})
ax.text(xs[2], getUpNum(max_y)+max_y_delta, methods[2], horizontalalignment='center', verticalalignment='center', fontdict={'size':18, 'weight':700})
...
ax.grid(True)
ax.legend()
plt.yticks(np.arange(20, getUpNum(max_y)+max_y_delta, 300), fontsize=12)
